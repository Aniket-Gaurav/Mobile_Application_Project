        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (newName.trim().length() > 0 && newDesc.trim().length() > 0){
                    ...
                    new NotificationUtils().showBotification(DetailActivity.this, "Updated Task", "A successful task has been successfully updated");


                }else{
                    new NotificationUtils().showBotification(DetailActivity.this, "Task not updated", "Your task was not updated as you did not fill in all the required fields.");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_info:
                Snackbar.make(parentContainer, "Developed by Aniket & Ojash", Snackbar.LENGTH_LONG)
                        .show();
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(R.string.button_positive, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        new NotificationUtils().showBotification(DetailActivity.this, "Task "+nameTaskStr+" deleted", "The task has been deleted "+nameTaskStr+" successfully");
                        goToBack();
                    }
                })
